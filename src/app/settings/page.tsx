    ...
    <div style={{ padding: "0 20px" }}>
      ...
      <div className="stagger-children" style={{ display: "flex", flexDirection: "column", gap: 16, marginTop: 8 }}>
        ...
        <div className="card" style={{ padding: "20px" }}>
          <label style={{ fontSize: 13, fontWeight: 600, color: "var(--text-dim)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
            Your Name
          </label>
          <input
            type="text"
        ...
        <div className="card" style={{ padding: "20px", marginTop: 8 }}>
          <label style={{ fontSize: 13, fontWeight: 600, color: "var(--danger)", textTransform: "uppercase", letterSpacing: "0.05em" }}>
            Danger Zone
          </label>
